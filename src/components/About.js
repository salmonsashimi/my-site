...
export default () => {
    ...
    return (
        <div className='about container'>
            ...
            <p>I first stumbled onto programming when I decided to pick up data analytics for self-development. Python was my language of choice then, and I purchased an online course to learn it.</p>
